...
const htmlRegex = /@html:(.*)(([\n\r].+?)*)(?=@author|@category|@code|@css|@date|@doc|@html|@icon|@public|@name|@params|@returns|@title|@text|@version|[\n ]+\*\/)/g
const minifyOptions = {
...
module.exports.colorTitle = colorTitle
