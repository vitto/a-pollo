...
$(function(){$(".highlight .code").each(function(){$(this).html($(this).html().replace(/[“”]{1,}/g,'"'))}),new Clipboard(".code-example");var e;$(document).on("click",".code-example",function(){var t,i;t=$(this).find(".code-example__message"),i=$(this).find(".code-example__message").data("text"),t.text("copied"),clearTimeout(e),e=setTimeout(function(){t.text(i),window.getSelection().removeAllRanges()},2e3)})});