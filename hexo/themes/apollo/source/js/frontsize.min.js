...
$(function(){$(".value").each(function(){$(this).text($(this).text().replace(/[“”]{1,}/g,'"'))}),new Clipboard(".code-example");var e;$(document).on("click",".code-example",function(){var t,a;t=$(this).find(".code-example__message"),a=$(this).find(".code-example__message").data("text"),t.text("copied"),clearTimeout(e),e=setTimeout(function(){t.text(a)},2e3)})});