...
jQuery.fn.selectText=function(){this.find("input").each(function(){0!=$(this).prev().length&&$(this).prev().hasClass("p_copy")||$('<p class="p_copy" style="position: absolute; z-index: -1;"></p>').insertBefore($(this)),$(this).prev().html($(this).val())});var e=document,t=this[0];if(console.log(this,t),e.body.createTextRange){var o=document.body.createTextRange();o.moveToElementText(t),o.select()}else if(window.getSelection){var n=window.getSelection(),o=document.createRange();o.selectNodeContents(t),n.removeAllRanges(),n.addRange(o)}},$(function(){$(".highlight .code").each(function(){$(this).html($(this).html().replace(/[“”]{1,}/g,'"'))}),new Clipboard(".apollo-code-example"),$(document).on("click",".apollo-page > p > code, .apollo-widget__description code",function(){$(this).selectText()});var e;$(document).on("click",".apollo-code-example",function(){var t,o;t=$(this).find(".apollo-code-example__message"),o=$(this).find(".apollo-code-example__message").data("text"),t.text("copied"),clearTimeout(e),e=setTimeout(function(){t.text(o),window.getSelection().removeAllRanges()},2e3)})});