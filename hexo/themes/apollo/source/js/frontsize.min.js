...
$(function(){new Clipboard(".code-example");$(document).on("click",".code-example",function(){var e,t;e=$(this).find(".code-example__message"),t=$(this).find(".code-example__message").data("text"),e.text("copied"),setTimeout(function(){e.text(t)},2e3)})});