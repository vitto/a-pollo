...
jQuery.fn.selectText=function(){this.find("input").each(function(){0!==$(this).prev().length&&$(this).prev().hasClass("p_copy")||$('<p class="p_copy" style="position: absolute; z-index: -1;"></p>').insertBefore($(this)),$(this).prev().html($(this).val())});var e,t=document,l=this[0];if(t.body.createTextRange)e=document.body.createTextRange(),e.moveToElementText(l),e.select();else if(window.getSelection){var o=window.getSelection();e=document.createRange(),e.selectNodeContents(l),o.removeAllRanges(),o.addRange(e)}},$(function(){$(document).on("click",".apollo-html-example",function(){var e=$(this).find(".apollo-html-example__bg").hasClass("apollo-html-example__bg--active");e?$(this).find(".apollo-html-example__bg").removeClass("apollo-html-example__bg--active"):$(this).find(".apollo-html-example__bg").addClass("apollo-html-example__bg--active")}),$(".highlight .code").each(function(){$(this).html($(this).html().replace(/[“”]{1,}/g,'"'))}),new Clipboard(".apollo-code-example"),$(document).on("click",".apollo-page > p > code, .apollo-widget__description code",function(){$(this).selectText()});var e;$(document).on("click",".apollo-code-example",function(){var t,l;t=$(this).find(".apollo-code-example__message"),l=$(this).find(".apollo-code-example__message").data("text"),t.text("copied"),clearTimeout(e),e=setTimeout(function(){t.text(l),window.getSelection().removeAllRanges()},2e3)})});