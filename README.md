...
[![Version](http://img.shields.io/:version-1.5.67-B89766.svg)][release]
...
- Add relative installation explanation for init command
- Fix init command unwanted error message
...
[release]: https://github.com/vitto/a-pollo/releases/tag/1.5.67
