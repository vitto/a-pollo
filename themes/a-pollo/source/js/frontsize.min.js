...
$(function(){var e,a,s,o,t,n,i,l,c,r,d,x,u,y,w,M;r=new TimelineMax,u=new TimelineMax,M=new TimelineMax,n=new ScrollMagic.Controller,e=Circ.easeInOut,a=2,o=1.75,s=.2,l=$("#logo-less"),d=$("#logo-sass"),y=$("#logo-css3"),t="#from-code-to-docs",c={curviness:o,autoRotate:!1,values:[{x:0,y:0},{x:150,y:100},{x:200,y:170}]},x={curviness:o,autoRotate:!1,values:[{x:0,y:0},{x:0,y:170}]},w={curviness:o,autoRotate:!1,values:[{x:0,y:0},{x:-150,y:100},{x:-200,y:170}]},r.add(TweenMax.to(l,a,{css:{bezier:c,scale:.25,rotation:90},ease:e})),u.add(TweenMax.to(d,a,{css:{bezier:x,scale:.25},ease:e,delay:s})),M.add(TweenMax.to(y,a,{css:{bezier:w,scale:.25,rotation:-90},ease:e,delay:1.5*s})),i=new ScrollMagic.Scene({triggerElement:t,duration:500,offset:300}),i.setPin(t),i.setTween([u,r,M]),i.addIndicators(),i.addTo(n)});