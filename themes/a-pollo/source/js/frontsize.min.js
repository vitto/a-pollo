...
$(function(){var e,a,s,o,t,n,d,c,i,l,x,y,r,w,u,M,T,g,p,m,v,z,I,b,R,f,S,C,E,O;l=new TimelineMax,r=new TimelineMax,M=new TimelineMax,R=new TimelineMax,f=new TimelineMax,S=new TimelineMax,p=new TimelineMax,n=new ScrollMagic.Controller,e=Circ.easeInOut,a=1.75,o=1.75,s=.2,O=Expo.easeInOut,C=2.5,E=3,c=$("#logo-less"),x=$("#logo-sass"),w=$("#logo-css3"),T=$("#mincer-upper"),g=$("#mincer-lower"),z=$("#page-styleguide-1"),I=$("#page-styleguide-2"),b=$("#page-styleguide-3"),t="#from-code-to-docs",i={curviness:o,autoRotate:!1,values:[{x:0,y:0},{x:150,y:100},{x:160,y:170}]},y={curviness:o,autoRotate:!1,values:[{x:0,y:0},{x:0,y:170}]},u={curviness:o,autoRotate:!1,values:[{x:0,y:0},{x:-150,y:100},{x:-160,y:170}]},m={curviness:o,autoRotate:!1,values:[{x:0,y:0},{x:-50,y:-5},{x:-100,y:-10}]},v={curviness:o,autoRotate:!1,values:[{x:0,y:0},{x:50,y:-5},{x:100,y:-10}]},l.add(TweenMax.to(c,a,{css:{bezier:i,scale:.25,rotation:90},ease:e})),r.add(TweenMax.to(x,a,{css:{bezier:y,scale:.25},ease:e,delay:s})),M.add(TweenMax.to(w,a,{css:{bezier:u,scale:.25,rotation:-90},ease:e,delay:1.5*s})),l.add(TweenMax.to(c,.15,{css:{opacity:0},ease:e})),r.add(TweenMax.to(x,.15,{css:{opacity:0},ease:e})),M.add(TweenMax.to(w,.15,{css:{opacity:0},ease:e})),R.add(TweenMax.to(z,C,{css:{y:140,scale:.5,zIndex:5},ease:O,delay:1})),f.add(TweenMax.to(I,C,{css:{y:110,scale:.25,zIndex:4,opacity:.6},ease:O,delay:1})),S.add(TweenMax.to(b,C,{css:{y:110,scale:.25,zIndex:3,opacity:.6},ease:O,delay:1})),R.add(TweenMax.to(z,E,{css:{scale:1,y:0},ease:O})),f.add(TweenMax.to(I,E,{css:{bezier:m,scale:.75,rotation:-10},ease:O,delay:.1})),S.add(TweenMax.to(b,E,{css:{bezier:v,scale:.75,rotation:10},ease:O,delay:.2})),p.add(TweenMax.to([T,g],.1,{css:{zIndex:1},ease:e,delay:3})),p.add(TweenMax.to([T,g],2,{css:{opacity:0},ease:e,delay:2})),d=new ScrollMagic.Scene({triggerElement:t,duration:300,offset:300}),d.setPin(t),d.setTween([r,l,M,p,R,f,S]),d.addTo(n)});