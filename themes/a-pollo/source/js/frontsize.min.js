...
$(function(){var e,a;e=$("#logo-less"),a="#from-code-to-docs";var o={entry:{curviness:1.25,autoRotate:!0,values:[{x:100,y:-20},{x:300,y:10}]},looping:{curviness:1.25,autoRotate:!0,values:[{x:510,y:60},{x:620,y:-60},{x:500,y:-100},{x:380,y:20},{x:500,y:60},{x:580,y:20},{x:620,y:15}]},leave:{curviness:1.25,autoRotate:!0,values:[{x:660,y:20},{x:800,y:130},{x:$(window).width()+300,y:-100}]}},s=new ScrollMagic.Controller,t=(new TimelineMax).add(TweenMax.to(e,1.2,{css:{bezier:o.entry},ease:Power1.easeInOut})).add(TweenMax.to(e,2,{css:{bezier:o.looping},ease:Power1.easeInOut})).add(TweenMax.to(e,1,{css:{bezier:o.leave},ease:Power1.easeInOut}));new ScrollMagic.Scene({triggerElement:a,duration:500,offset:100}).setPin(a).setTween(t).addIndicators().addTo(s)});